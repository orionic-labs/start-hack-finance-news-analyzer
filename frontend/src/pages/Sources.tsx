...
import { Rss, Settings, Shield, CheckCircle, Clock, XCircle, Globe, Plus, LucideIcon } from 'lucide-react';
...
export default function Sources() {
    ...
    const getStatusBadge = (status: string) => {
        const statusConfig: { [key: string]: { color: string; icon: LucideIcon } } = {
            active: {
                color: 'bg-dashboard-success/10 text-dashboard-success border-dashboard-success/20',
                icon: CheckCircle,
            },
            maintenance: {
                color: 'bg-dashboard-warning/10 text-dashboard-warning border-dashboard-warning/20',
                icon: Clock,
            },
            error: {
                color: 'bg-dashboard-danger/10 text-dashboard-danger border-dashboard-danger/20',
                icon: XCircle,
            },
        };
                ...
                <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>Add a new financial news source to monitor</DialogDescription>
                        </DialogHeader>
                        <div className="space-y-4 py-4">
                            <div className="space-y-2">
                                <Label htmlFor="sourceName">Source Name</Label>
                                <Input id="sourceName" value={sourceName} onChange={(e) => setSourceName(e.target.value)} placeholder="Bloomberg" />
                            </div>
                            <div className="space-y-2">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="sourceKeywords">Keywords (comma separated)</Label>
                                <Input
                                    id="sourceKeywords"
                            ...
                            <div className="flex gap-2">
                                <Button
                                    ...
                                    className="flex-1"
                                >
                                    <Shield className="w-4 h-4 mr-2" /> {isVerifying ? 'Verifying...' : 'Verify Source'}
                                </Button>
                                <Button onClick={handleAddSource} disabled={!sourceName || !sourceLink || isVerifying} className="flex-1">
                                    Add Source
                                </Button>
                            </div>
                        </div>
